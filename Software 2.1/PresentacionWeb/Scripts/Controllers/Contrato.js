...
function ActualizarContrato() {
    ...
    $.ajax({
        type: "POST",
        url: "../Contrato/ActualizarContrato",
        data: {
...
function VistaAnularContrato() {
    $.ajax({
        url: "../Contrato/VistaAnularContrato",
        data: {
            Id_Empleado: $("#VerEmpleado #Id_Empleado").val()
        },
        type: "POST",
